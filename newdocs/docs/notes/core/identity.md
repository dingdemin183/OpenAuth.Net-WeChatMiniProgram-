...
OpenAuth.Net支持两种登录认证方式：Token认证和==自己搭建=={.tip}的统一认证服务OpenAuth.Identity。
...
不同于其他项目使用微信登录、支付宝登录等,OpenAuth.Net的统一认证指的是自己搭建一套基于 OpenIddict 的统一身份认证服务，为其他项目提供 OpenID Connect / OAuth 2.0 协议支持，提供安全可靠的身份验证服务。

项目中的OpenAuth.Identity启动后，直接访问[http://localhost:12796](http://localhost:12796)，效果如下：
![2026-06-27-20-22-30](http://img.openauth.net.cn/2026-06-27-20-22-30.png)
...
![2026-06-27-23-41-50](http://pic.openauth.net.cn/2026-06-27-23-41-50.png)

这时点击登录超链接，会跳转到OpenAuth.Identity登录界面。效果如下：
![2026-06-27-20-23-17](http://img.openauth.net.cn/2026-06-27-20-23-17.png)

输入用户名和密码，登录成功后，会自动跳转回原页面，并提示授权成功。
