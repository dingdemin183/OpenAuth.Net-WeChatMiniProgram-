...
namespace OpenAuth.App.Flow
{
    ...
    public class FlowRuntime
    {
        ...
        public string GetNextMakers(NodeDesignateReq request = null)
        {
            ...
            //从url审批过来的，request不为空，但是这两个属性是空的
            if(request.NodeDesignateType == null || request.NodeDesignates == null){
                request.NodeDesignateType = nextNode.setInfo.NodeDesignate;
                request.NodeDesignates = nextNode.setInfo.NodeDesignateData.datas;
            }
